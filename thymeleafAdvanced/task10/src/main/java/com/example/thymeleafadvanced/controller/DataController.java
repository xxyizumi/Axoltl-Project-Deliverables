...
public class DataController {
    ...
    public String roleDemo() {
        return "pages/demo/role-demo";
    }

    @GetMapping("/user-info")
    public String userInfo() {
        return "pages/demo/user-info";
    }

    @GetMapping("/csrf-demo")
    public String csrfDemo() {
        return "pages/demo/csrf-demo";
    }

    @PostMapping("/csrf-submit")
    public String csrfSubmit(@RequestParam String message, Model model) {
    ...
    @ResponseBody
    public Map<String, Object> csrfAjax(@RequestBody Map<String, String> payload) {
        String message = payload.getOrDefault("message", "");
        return Map.of(
            "status", "success",
            "message", "受信しました: " + message,
            "timestamp", System.currentTimeMillis()
        );
    }

    @PostMapping("/upload")
    public String csrfUpload(
        @RequestParam("file") MultipartFile multipartFile,
        Model model
    ) {
        model.addAttribute("submittedMessage", multipartFile.getOriginalFilename());
        model.addAttribute("success", true);
        return "pages/demo/csrf-demo";
    }
    
    @GetMapping("/custom-error")
    public String customError(@RequestParam String param) {
        return "pages/demo/custom-error";
    }
